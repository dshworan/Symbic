      ...
      <View style={styles.modalContainer}>
        <View style={styles.modalContent}>
          <ScrollView style={styles.scrollView}>
            ...
            <Text style={styles.lastUpdated}>Last Updated: May 6, 2025</Text>

            <View style={styles.section}>
              <Text style={styles.sectionTitle}>Introduction</Text>
              <Text style={styles.text}>
                Welcome to the Trios app ("we", "our", or "us"). We respect your privacy and are committed to protecting your information. This Privacy Policy explains how we handle your information when you use our mobile application.
              </Text>
            </View>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.text}>
                Trios is a casual game and does not collect personally identifiable information directly from users. However, we may work with third-party services that collect limited data automatically.
              </Text>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.text}>
                Trios is not intended for children under the age of 13. We do not knowingly collect personal data from children. If you believe a child has provided us with personal information, please contact us so we can take appropriate action.
              </Text>
            </View>
