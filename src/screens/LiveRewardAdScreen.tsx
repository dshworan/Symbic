...
const LiveRewardAdScreen: React.FC<LiveRewardAdScreenProps> = ({ onBackPress }) => {
        ...
        <View style={styles.content}>
          ...
          {isWeb ? (
            ...
            <View style={styles.adSection}>
              <Text style={styles.adId}>Live ID: {REWARD_AD_ID}</Text>
...
export default LiveRewardAdScreen; 